...
public class TaskListTest {
    ...
    void testToStringNumbering() {
        ...
        assertTrue(s.contains(a.toString()) && s.contains(b.toString()), "Should include all tasks");
    }

    @Test
    public void toCsvString_todoTasks_buildsLinesWithTrailingNewLine() {
        TaskList tl = new TaskList();
        // Adjust expected CSVs to whatever your Task implementations output.
        ...
        String expected = t1.toCsvString() + "\n" + t2.toCsvString() + "\n";
        assertEquals(expected, tl.toCsvString());
    }
